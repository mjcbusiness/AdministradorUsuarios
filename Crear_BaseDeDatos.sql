...
INSERT INTO dbo.Usuarios (Nombre, Apellido, Documento, Email, Rol)
    VALUES
    ('Maxi', 'Cari', '12345678', 'maxi.admin@mail.com', 'Administrador'),
    ('Juan', 'Pérez', '87654321', 'juan.user@mail.com', 'Usuario');